...
gestationmean.nonsmoker = mean(data.nonsmoker.clean$gestation)
n.nonsmoker = length(data.nonsmoker.clean$gestation)
sdgestation.nonsmoker = sd(data.nonsmoker.clean$gestation, na.rm = FALSE)
error.nonsmoker = qt(.975, length(data.nonsmoker.clean$gestation)-1)*(sdgestation.nonsmoker/sqrt(n.nonsmoker))
...
gestationmean.smoker = mean(data.smoker.clean$gestation)
n.smoker = length(data.smoker.clean$gestation)
sdgestation.smoker = sd(data.smoker.clean$gestation, na.rm = FALSE)
error.smoker = qt(.975, length(data.smoker.clean$gestation)-1)*(sdgestation.smoker/sqrt(n.smoker))
